...
# if none of the other terminals is specificed.
   ...
   # set output "aircraft/p51d/results/alm_perf_fast_roll.png"

   # This is how to output the plot in PDF format. (Not available on Mac)
   # set terminal pdfcairo color size 8.5,11
   # set output "aircraft/t6texan2/results/alm_perf_fast_roll.pdf"
...
set ylabel "Высота, м"
plot \
   "aircraft/p51d/results/alm_perf_fast_roll.csv" using 1:($43*0.3048) title "" with lines\
...
set xlabel ""
plot \
   "aircraft/p51d/results/alm_perf_fast_roll.csv" using 1:33 title "" with lines\
...
plot  \
   \
   "aircraft/p51d/results/alm_perf_fast_roll.csv" using 1:32 title "" with lines\
